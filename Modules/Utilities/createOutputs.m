% =========================================================================
% Name   : createOutputs.m
% Author : Brandon Sloan
% Date   : 5/26/21
%
% DESCRIPTION
% This function creates the MATLAB table that will be used to store the
% LSM outputs from Sloan et al. (2021).
%
% INPUTS
...
function Results = createOutputs(Timesteps)
