% =========================================================================
% Name   : selectFluxData.m
% Author : Brandon Sloan
% Date   : 5/26/21
%
% DESCRIPTION
% This function selects the appropriate flux data for use as forcings in
% the LSM for Sloan et al. (2021).
%
% INPUTS
...
function [FluxData,datelog] = selectFluxData(years,months,days,hours,SiteFile)
...
logseason = ismember(dates(:,1),years) & ismember(dates(:,2),months)...
